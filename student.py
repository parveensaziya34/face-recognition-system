...
class Student:
    def __init__(self,root):
        ...
        # first img
        img=Image.open(r"C:\MinGW\bin\OneDrive\Desktop\Face recognition system\college_images\face-recognition.png")
        ...
        # second img
        img1=Image.open(r"C:\MinGW\bin\OneDrive\Desktop\Face recognition system\college_images\smart-attendance.jpg")
        ...
        # third image
        img2=Image.open(r"C:\MinGW\bin\OneDrive\Desktop\Face recognition system\college_images\se.jpg")
        ...
        # bg img
        img3=Image.open(r"C:\MinGW\bin\OneDrive\Desktop\Face recognition system\college_images\wp2551980.jpg")
        ...
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current course informtion",font=("times new roman",12,"bold"))
        ...
        course_combo["values"]=("Select Course","FE","IT","SE","TE","BE")
        ...
        sem_combo["values"]=("Select sem","sem-1","sem-2","sem-3")
        sem_combo.current(0)
        sem_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)


        # Class Student information
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student informtion",font=("times new roman",12,"bold"))
        ...
        # class_entry=ttk.Entry(class_student_frame,textvariable=self.var_div,width=20,font=("times new roman",13,"bold"))
        ...
        # gender_entry.grid(row=2,column=1,padx=10,pady=5,sticky=W)sem_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",12,"bold"),state="read only")
        ...
        Radiobutton1=ttk.Radiobutton(class_student_frame,text="take Photo Sample",variable=self.var_radio1,value="Yes")
        ...
        img_right=Image.open(r"C:\MinGW\bin\OneDrive\Desktop\Face recognition system\college_images\gettyimages-1022573162.jpg")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    ...
                    if not update:
                        return 
                messagebox.showinfo("Succes","student details successfulyy updated",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                print(f"Department: {self.var_dep.get()}, Name: {self.var_std_name.get()}, Student ID: {self.var_std_id.get()}")
                ...
                def face_cropped(img):
                    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)  # Corrected to BGR2GRAY
                ...
                while True:
                    ...
                    if cropped_face is not None:
                        ...
                        face = cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)  # Corrected to BGR2GRAY
